...
namespace ChessWeb.Persistence.Migrations
{
    ...
    [Migration("20201204182247_GameSummary_Add")]
    partial class GameSummary_Add
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChessWeb.Domain.Entities.GameSummary", b =>
                {
                    ...
                    b.Property<long?>("ActiveColorId")
                        .HasColumnType("bigint");

                    b.Property<long?>("BlackUserId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ChessWeb.Domain.Entities.GameSummary", b =>
                {
                    b.HasOne("ChessWeb.Domain.Entities.Color", "ActiveColor")
                        .WithMany()
                        .HasForeignKey("ActiveColorId");
                    ...
                    b.HasOne("ChessWeb.Domain.Entities.GameStatus", "Status")
                        .WithMany()
                    ...
                    b.HasOne("ChessWeb.Domain.Entities.User", "Winner")
                        .WithMany()
                        .HasForeignKey("WinnerId");

                    b.Navigation("ActiveColor");
