...
namespace ChessWeb.Persistence.Migrations
{
    ...
    [Migration("20201125061729_AsTable_ChessGameInfo")]
    partial class AsTable_ChessGameInfo
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChessWeb.Domain.Entities.Game", b =>
                {
                    ...
                    b.Property<long?>("ChessGameInfoId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ChessWeb.Domain.Entities.Game", b =>
                {
                    b.HasOne("ChessWeb.Domain.Entities.ChessGameInfo", "ChessGameInfo")
                        .WithMany()
                        .HasForeignKey("ChessGameInfoId");
