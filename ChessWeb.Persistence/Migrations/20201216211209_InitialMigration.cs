        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ColorType = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Fen = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    WhiteUserId = table.Column<string>(type: "text", nullable: true),
                    WhiteUsername = table.Column<string>(type: "text", nullable: true),
                    BlackUserId = table.Column<string>(type: "text", nullable: true),
                    BlackUsername = table.Column<string>(type: "text", nullable: true),
                    GameSummaryId = table.Column<long>(type: "bigint", nullable: false),
                    Status = table.Column<byte>(type: "smallint", nullable: false),
                    LastMove = table.Column<string>(type: "character varying(5)", maxLength: 5, nullable: true),
                    ActiveColor = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MoveNext = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
